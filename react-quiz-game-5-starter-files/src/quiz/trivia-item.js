...
function TriviaItem({difficulty, correctAnswer, incorrectAnswers, question, onNextClick, onAnswerSelected}){
    ...
    return (
    <div>
        <p className="trivia-item__question">{question} {difficulty}</p>
